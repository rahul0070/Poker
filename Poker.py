...
class PokerGame:
	...
	def compare_MaxFrequent(self, l1, l2):
		while len(l1)>0:
			h1 = self.highestFrequent(l1)
			h2 = self.highestFrequent(l2)
	...
	def findWinner(self, score1, score2):
		return self.compare(score2, score1)


	def findHighest(self, hand1, hand2):
		return self.compare_MaxFrequent(self.splitRank(hand1), self.splitRank(hand2))
	...
	def gameResult(self, player_one, player_two):
		...
		if scoreOfPlayer1 == scoreOfPlayer2:
			result = self.findHighest(player_one, player_two)
